...
public class ServicioCanciones {
    ...
    public Cancion agregarCancion(Cancion cancionNew){
        return this.repositorioCanciones.save(cancionNew);
    }

    public Cancion actualizaCancion(Cancion cancionSel){
        return repositorioCanciones.save(cancionSel);
    }
